...
class ContentOpfParser final : public Print {
 ...
 public:
  // Bounds title/author/language/identifierBuffer/subjectBuffer against a
  // runaway or malformed field in an untrusted EPUB's content.opf -- matches
  // the cap Epub.cpp's DescriptionParser already applies to dc:description,
  // for the same reason (real book metadata is far smaller than this).
